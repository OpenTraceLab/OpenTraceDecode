 ...
 *
 * The <a href="http://opentrace.org">opentrace</a> project aims at creating a
 ...
 *
 * <a href="http://opentrace.org/wiki/Libopentracedecode">libopentracedecode</a> is a
 * shared library written in C which provides the basic API for (streaming)
 * protocol decoding functionality.
 *
 * The <a href="http://opentrace.org/wiki/Protocol_decoders">protocol decoders</a>
 ...
 *
 * There is one mailing list for opentrace/libopentracedecode: <a href="https://lists.sourceforge.net/lists/listinfo/opentrace-devel">opentrace-devel</a>.
 *
 * @section sec_irc IRC
 *
 * You can find the opentrace developers in the
 * <a href="ircs://irc.libera.chat/#opentrace">\#opentrace</a>
 * IRC channel on Libera.Chat.
 *
 * @section sec_website Website
 *
 * <a href="http://opentrace.org/wiki/Libopentracedecode">opentrace.org/wiki/Libopentracedecode</a>
 */
 ...
 * a "opentracedecode" Python module.
 *
 * Then, it searches for opentrace protocol decoders in the "decoders"
 ...
 * in order to search for opentrace protocol decoders in the specified
 ...
 * Python modules which have the same name as a opentrace protocol decoder in
