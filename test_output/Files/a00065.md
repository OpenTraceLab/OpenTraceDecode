...
|                | Name           |
| -------------- | -------------- |
| char * | **[py_stringify](Files/a00065.md#function-py-stringify)**(PyObject * py_obj) |
| char * | **[py_get_string_attr](Files/a00065.md#function-py-get-string-attr)**(PyObject * py_obj, const char * attr) |
...
```cpp
static char * py_get_string_attr(
    PyObject * py_obj,
    const char * attr
)
```
